...
jsonUri=https://raw.githubusercontent.com/richeney/azure-blueprints/master/modules/BluePrism/guidtest.json
...
tf="
module \"guidtest\" {
    source  = \"github.com/richeney/azure-blueprints/modules/BluePrism\"
    guid    = \"$guid7\"
    test    = \"7\"
}
'
